...
function BookNow3(){
    ...
    const book = (()=>{
        ...
        const bookings = {
           ...
           room:"Presidential Suite", name:name, email:email, cell:cell, checkIn:checkIn, checkOut:checkOut, guests:guests 
        }
    ...
    return(
        <div>
            ...
            <div className="guestRoom"><h1>Presidential Suite</h1></div><br></br><br></br>
            ...
            <div className="price" style={{'color':'green'}}><h1>R800</h1></div>
